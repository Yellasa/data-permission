...
/**
 * DataAuthAnnotation的处理类
 *
 * @ClassName: DataAuthAnnotationProcessor
 * @Author: yangting@ty
 * @CreateDate: 2018/3/20 18:17
 * @UpdateUser: 更新者
 * @UpdateDate: 2018/3/20 18:17
 * @UpdateRemark: 更新说明
 **/
public class DataAuthAnnotationProcessor extends AbstractProcessor
{
    //类名的前缀、后缀
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement typeElement : annotations) {
            for (Element e : roundEnv.getElementsAnnotatedWith(typeElement)) {
                ...
                //获取注解
                DataAuthAnnotation dataAuthAnnotation = e.getAnnotation(DataAuthAnnotation.class);


                dataAuthAnnotation.value();


                dataAuthAnnotation.fields();
                ...
                try {
                    ...
                    try {
                        ...
                        pw.println("        System.out.println(\"注解的code: " + dataAuthAnnotation.value() + "\");");
                        pw.println("        System.out.println(\"注解的fields: " + dataAuthAnnotation.fields() + "\");");
