package com.farpower.datapermission.interceptors;
...
@Intercepts({ @Signature(type = Executor.class, method = "query", args = {
        ...
        ResultHandler.class }) })
public class PermissionInterceptors implements Interceptor
{

    private Logger loggr = LoggerFactory.getLogger(PermissionInterceptors.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable
    {
        ...
        loggr.info("originalSql--->  "+originalSql);
